...
const mockedUpdateImport = updateImport as jest.MockedFunction<typeof updateImport>;
...
const mockedScrapeInstagramPost =
  scrapeInstagramPost as jest.MockedFunction<typeof scrapeInstagramPost>;
const mockedDownloadMedia = downloadMedia as jest.MockedFunction<typeof downloadMedia>;
const mockedCleanupMedia = cleanupMedia as jest.MockedFunction<typeof cleanupMedia>;
const mockedUploadToGemini = uploadToGemini as jest.MockedFunction<typeof uploadToGemini>;
const mockedExtractRecipe = extractRecipe as jest.MockedFunction<typeof extractRecipe>;
